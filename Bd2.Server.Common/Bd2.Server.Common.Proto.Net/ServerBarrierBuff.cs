...
public sealed class ServerBarrierBuff : IMessage<ServerBarrierBuff>, IMessage, IEquatable<ServerBarrierBuff>, IDeepCloneable<ServerBarrierBuff>, IBufferMessage
{
	private static readonly MessageParser<ServerBarrierBuff> _parser = new MessageParser<ServerBarrierBuff>(() => new ServerBarrierBuff());
	...
	public static MessageParser<ServerBarrierBuff> Parser => _parser;

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => BuffListInfoReflection.Descriptor.MessageTypes[3];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ServerBarrierBuff()
	{
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ServerBarrierBuff(ServerBarrierBuff other)
		: this()
	{
		id_ = other.id_;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ServerBarrierBuff Clone()
	{
		return new ServerBarrierBuff(this);
	}
	...
	{
		return Equals(other as ServerBarrierBuff);
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public bool Equals(ServerBarrierBuff other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(ServerBarrierBuff other)
	{
		if (other != null)
		{
			if (other.Id != 0)
