...
public sealed class BattleEndTestRequest : IMessage<BattleEndTestRequest>, IMessage, IEquatable<BattleEndTestRequest>, IDeepCloneable<BattleEndTestRequest>, IBufferMessage
{
	private static readonly MessageParser<BattleEndTestRequest> _parser = new MessageParser<BattleEndTestRequest>(() => new BattleEndTestRequest());
	...
	public const int IsMonsterHuntNextFieldNumber = 7;

	private bool isMonsterHuntNext_;

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public static MessageParser<BattleEndTestRequest> Parser => _parser;

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => BattleEndTestRequestReflection.Descriptor.MessageTypes[0];
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public bool IsMonsterHuntNext
	{
		get
		{
			return isMonsterHuntNext_;
		}
		set
		{
			isMonsterHuntNext_ = value;
		}
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public BattleEndTestRequest()
	{
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public BattleEndTestRequest(BattleEndTestRequest other)
		: this()
	{
		seq_ = other.seq_;
		...
		isMonsterHuntNext_ = other.isMonsterHuntNext_;
		_unknownFields = UnknownFieldSet.Clone(other._unknownFields);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public BattleEndTestRequest Clone()
	{
		return new BattleEndTestRequest(this);
	}
	...
	{
		return Equals(other as BattleEndTestRequest);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(BattleEndTestRequest other)
	{
		if (other != null)
		{
			if (other != this)
			{
				if (Seq == other.Seq && BattleResult == other.BattleResult && charInfo_.Equals(other.charInfo_) && PackId == other.PackId && achieveIndex_.Equals(other.achieveIndex_) && endInvenIndex_.Equals(other.endInvenIndex_) && IsMonsterHuntNext == other.IsMonsterHuntNext)
				{
	...
	public override int GetHashCode()
	{
		...
		if (IsMonsterHuntNext)
		{
			num ^= IsMonsterHuntNext.GetHashCode();
		}
	...
	void IBufferMessage.InternalWriteTo(ref WriteContext output)
	{
		...
		if (IsMonsterHuntNext)
		{
			...
			output.WriteBool(IsMonsterHuntNext);
		}
		if (_unknownFields != null)
		{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(BattleEndTestRequest other)
	{
		if (other != null)
		{
			if (other.Seq != 0)
			...
			if (other.IsMonsterHuntNext)
			{
				IsMonsterHuntNext = other.IsMonsterHuntNext;
			}
	...
	void IBufferMessage.InternalMergeFrom(ref ParseContext input)
	{
		...
		while ((num = input.ReadTag()) != 0)
		{
			...
			case 50u:
				...
				break;
			case 56u:
				IsMonsterHuntNext = input.ReadBool();
				break;
			default:
