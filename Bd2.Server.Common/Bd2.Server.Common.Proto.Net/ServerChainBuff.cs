...
public sealed class ServerChainBuff : IMessage<ServerChainBuff>, IMessage, IEquatable<ServerChainBuff>, IDeepCloneable<ServerChainBuff>, IBufferMessage
{
	private static readonly MessageParser<ServerChainBuff> _parser = new MessageParser<ServerChainBuff>(() => new ServerChainBuff());
	...
	public static MessageParser<ServerChainBuff> Parser => _parser;

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => BuffListInfoReflection.Descriptor.MessageTypes[11];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ServerChainBuff()
	{
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public ServerChainBuff(ServerChainBuff other)
		: this()
	{
		id_ = other.id_;
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public ServerChainBuff Clone()
	{
		return new ServerChainBuff(this);
	}
	...
	{
		return Equals(other as ServerChainBuff);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(ServerChainBuff other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public void MergeFrom(ServerChainBuff other)
	{
		if (other != null)
		{
			if (other.Id != 0)
