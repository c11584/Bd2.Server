...
public sealed class QuestTextTable : IMessage<QuestTextTable>, IMessage, IEquatable<QuestTextTable>, IDeepCloneable<QuestTextTable>, IBufferMessage
{
	private static readonly MessageParser<QuestTextTable> _parser = new MessageParser<QuestTextTable>(() => new QuestTextTable());
	...
	[DebuggerNonUserCode]
	public static MessageParser<QuestTextTable> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => QuestTextTableReflection.Descriptor.MessageTypes[0];
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public QuestTextTable()
	{
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTextTable(QuestTextTable other)
		: this()
	{
		date_ = other.date_;
		id_ = other.id_;
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public QuestTextTable Clone()
	{
		return new QuestTextTable(this);
	}
	...
	{
		return Equals(other as QuestTextTable);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(QuestTextTable other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(QuestTextTable other)
	{
		if (other != null)
		{
