...
public sealed class QuestTable11003 : IMessage<QuestTable11003>, IMessage, IEquatable<QuestTable11003>, IDeepCloneable<QuestTable11003>, IBufferMessage
{
	private static readonly MessageParser<QuestTable11003> _parser = new MessageParser<QuestTable11003>(() => new QuestTable11003());
	...
	public static MessageParser<QuestTable11003> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => QuestTable11003Reflection.Descriptor.MessageTypes[0];
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public QuestTable11003()
	{
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable11003(QuestTable11003 other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable11003 Clone()
	{
		return new QuestTable11003(this);
	}
	...
	{
		return Equals(other as QuestTable11003);
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public bool Equals(QuestTable11003 other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(QuestTable11003 other)
	{
		if (other != null)
		{
