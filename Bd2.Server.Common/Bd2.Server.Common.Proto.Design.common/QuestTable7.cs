...
public sealed class QuestTable7 : IMessage<QuestTable7>, IMessage, IEquatable<QuestTable7>, IDeepCloneable<QuestTable7>, IBufferMessage
{
	private static readonly MessageParser<QuestTable7> _parser = new MessageParser<QuestTable7>(() => new QuestTable7());
	...
	public static MessageParser<QuestTable7> Parser => _parser;

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => QuestTable7Reflection.Descriptor.MessageTypes[0];
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public QuestTable7(QuestTable7 other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable7 Clone()
	{
		return new QuestTable7(this);
	}
	...
	{
		return Equals(other as QuestTable7);
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public bool Equals(QuestTable7 other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public void MergeFrom(QuestTable7 other)
	{
		if (other != null)
		{
