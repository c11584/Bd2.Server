...
public sealed class QuestTable2002 : IMessage<QuestTable2002>, IMessage, IEquatable<QuestTable2002>, IDeepCloneable<QuestTable2002>, IBufferMessage
{
	private static readonly MessageParser<QuestTable2002> _parser = new MessageParser<QuestTable2002>(() => new QuestTable2002());
	...
	[DebuggerNonUserCode]
	public static MessageParser<QuestTable2002> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => QuestTable2002Reflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable2002()
	{
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public QuestTable2002(QuestTable2002 other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable2002 Clone()
	{
		return new QuestTable2002(this);
	}
	...
	{
		return Equals(other as QuestTable2002);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(QuestTable2002 other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(QuestTable2002 other)
	{
		if (other != null)
		{
