...
public sealed class EvilCastleEnvyTowerTable : IMessage<EvilCastleEnvyTowerTable>, IMessage, IEquatable<EvilCastleEnvyTowerTable>, IDeepCloneable<EvilCastleEnvyTowerTable>, IBufferMessage
{
	private static readonly MessageParser<EvilCastleEnvyTowerTable> _parser = new MessageParser<EvilCastleEnvyTowerTable>(() => new EvilCastleEnvyTowerTable());
	...
	[DebuggerNonUserCode]
	public static MessageParser<EvilCastleEnvyTowerTable> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => EvilCastleEnvyTowerTableReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public EvilCastleEnvyTowerTable()
	{
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public EvilCastleEnvyTowerTable(EvilCastleEnvyTowerTable other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public EvilCastleEnvyTowerTable Clone()
	{
		return new EvilCastleEnvyTowerTable(this);
	}
	...
	{
		return Equals(other as EvilCastleEnvyTowerTable);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(EvilCastleEnvyTowerTable other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(EvilCastleEnvyTowerTable other)
	{
		if (other != null)
		{
