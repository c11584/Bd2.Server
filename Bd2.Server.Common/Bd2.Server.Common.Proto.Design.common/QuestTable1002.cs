...
public sealed class QuestTable1002 : IMessage<QuestTable1002>, IMessage, IEquatable<QuestTable1002>, IDeepCloneable<QuestTable1002>, IBufferMessage
{
	private static readonly MessageParser<QuestTable1002> _parser = new MessageParser<QuestTable1002>(() => new QuestTable1002());
	...
	[DebuggerNonUserCode]
	public static MessageParser<QuestTable1002> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => QuestTable1002Reflection.Descriptor.MessageTypes[0];
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public QuestTable1002()
	{
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable1002(QuestTable1002 other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable1002 Clone()
	{
		return new QuestTable1002(this);
	}
	...
	{
		return Equals(other as QuestTable1002);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(QuestTable1002 other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public void MergeFrom(QuestTable1002 other)
	{
		if (other != null)
		{
