...
public sealed class QuestTable4 : IMessage<QuestTable4>, IMessage, IEquatable<QuestTable4>, IDeepCloneable<QuestTable4>, IBufferMessage
{
	private static readonly MessageParser<QuestTable4> _parser = new MessageParser<QuestTable4>(() => new QuestTable4());
	...
	public static MessageParser<QuestTable4> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => QuestTable4Reflection.Descriptor.MessageTypes[0];
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public QuestTable4(QuestTable4 other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable4 Clone()
	{
		return new QuestTable4(this);
	}
	...
	{
		return Equals(other as QuestTable4);
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public bool Equals(QuestTable4 other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(QuestTable4 other)
	{
		if (other != null)
		{
