...
public sealed class QuestTable14 : IMessage<QuestTable14>, IMessage, IEquatable<QuestTable14>, IDeepCloneable<QuestTable14>, IBufferMessage
{
	private static readonly MessageParser<QuestTable14> _parser = new MessageParser<QuestTable14>(() => new QuestTable14());
	...
	public static MessageParser<QuestTable14> Parser => _parser;

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => QuestTable14Reflection.Descriptor.MessageTypes[0];
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public QuestTable14(QuestTable14 other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public QuestTable14 Clone()
	{
		return new QuestTable14(this);
	}
	...
	{
		return Equals(other as QuestTable14);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(QuestTable14 other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public void MergeFrom(QuestTable14 other)
	{
		if (other != null)
		{
