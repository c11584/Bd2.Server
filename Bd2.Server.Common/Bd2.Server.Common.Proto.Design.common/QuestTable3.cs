...
public sealed class QuestTable3 : IMessage<QuestTable3>, IMessage, IEquatable<QuestTable3>, IDeepCloneable<QuestTable3>, IBufferMessage
{
	private static readonly MessageParser<QuestTable3> _parser = new MessageParser<QuestTable3>(() => new QuestTable3());
	...
	public static MessageParser<QuestTable3> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => QuestTable3Reflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable3(QuestTable3 other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable3 Clone()
	{
		return new QuestTable3(this);
	}
	...
	{
		return Equals(other as QuestTable3);
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public bool Equals(QuestTable3 other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public void MergeFrom(QuestTable3 other)
	{
		if (other != null)
		{
