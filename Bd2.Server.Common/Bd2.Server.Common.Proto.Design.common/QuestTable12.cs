...
public sealed class QuestTable12 : IMessage<QuestTable12>, IMessage, IEquatable<QuestTable12>, IDeepCloneable<QuestTable12>, IBufferMessage
{
	private static readonly MessageParser<QuestTable12> _parser = new MessageParser<QuestTable12>(() => new QuestTable12());
	...
	public static MessageParser<QuestTable12> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => QuestTable12Reflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable12(QuestTable12 other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable12 Clone()
	{
		return new QuestTable12(this);
	}
	...
	{
		return Equals(other as QuestTable12);
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public bool Equals(QuestTable12 other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public void MergeFrom(QuestTable12 other)
	{
		if (other != null)
		{
