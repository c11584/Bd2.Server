...
public sealed class QuestTable2 : IMessage<QuestTable2>, IMessage, IEquatable<QuestTable2>, IDeepCloneable<QuestTable2>, IBufferMessage
{
	private static readonly MessageParser<QuestTable2> _parser = new MessageParser<QuestTable2>(() => new QuestTable2());
	...
	[DebuggerNonUserCode]
	public static MessageParser<QuestTable2> Parser => _parser;

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => QuestTable2Reflection.Descriptor.MessageTypes[0];
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public QuestTable2(QuestTable2 other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public QuestTable2 Clone()
	{
		return new QuestTable2(this);
	}
	...
	{
		return Equals(other as QuestTable2);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(QuestTable2 other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(QuestTable2 other)
	{
		if (other != null)
		{
