...
public sealed class BattleEndTestResponse : IMessage<BattleEndTestResponse>, IMessage, IEquatable<BattleEndTestResponse>, IDeepCloneable<BattleEndTestResponse>, IBufferMessage
{
	private static readonly MessageParser<BattleEndTestResponse> _parser = new MessageParser<BattleEndTestResponse>(() => new BattleEndTestResponse());
	...
	[DebuggerNonUserCode]
	public static MessageParser<BattleEndTestResponse> Parser => _parser;

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => BattleEndTestResponseReflection.Descriptor.MessageTypes[0];
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public BattleEndTestResponse()
	{
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public BattleEndTestResponse(BattleEndTestResponse other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public BattleEndTestResponse Clone()
	{
		return new BattleEndTestResponse(this);
	}
	...
	{
		return Equals(other as BattleEndTestResponse);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(BattleEndTestResponse other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public void MergeFrom(BattleEndTestResponse other)
	{
		if (other == null)
		{
			return;
