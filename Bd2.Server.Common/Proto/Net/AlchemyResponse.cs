...
public sealed class AlchemyResponse : IMessage<AlchemyResponse>, IMessage, IEquatable<AlchemyResponse>, IDeepCloneable<AlchemyResponse>, IBufferMessage
{
	private static readonly MessageParser<AlchemyResponse> _parser = new MessageParser<AlchemyResponse>(() => new AlchemyResponse());
	...
	public static MessageParser<AlchemyResponse> Parser => _parser;

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => AlchemyResponseReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public AlchemyResponse(AlchemyResponse other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public AlchemyResponse Clone()
	{
		return new AlchemyResponse(this);
	}
	...
	{
		return Equals(other as AlchemyResponse);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(AlchemyResponse other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(AlchemyResponse other)
	{
		if (other != null)
		{
