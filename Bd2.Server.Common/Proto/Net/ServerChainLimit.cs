...
public sealed class ServerChainLimit : IMessage<ServerChainLimit>, IMessage, IEquatable<ServerChainLimit>, IDeepCloneable<ServerChainLimit>, IBufferMessage
{
	private static readonly MessageParser<ServerChainLimit> _parser = new MessageParser<ServerChainLimit>(() => new ServerChainLimit());
	...
	public static MessageParser<ServerChainLimit> Parser => _parser;

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => BuffListInfoReflection.Descriptor.MessageTypes[13];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ServerChainLimit()
	{
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public ServerChainLimit(ServerChainLimit other)
		: this()
	{
		id_ = other.id_;
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public ServerChainLimit Clone()
	{
		return new ServerChainLimit(this);
	}
	...
	{
		return Equals(other as ServerChainLimit);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(ServerChainLimit other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(ServerChainLimit other)
	{
		if (other != null)
		{
			if (other.Id != 0)
