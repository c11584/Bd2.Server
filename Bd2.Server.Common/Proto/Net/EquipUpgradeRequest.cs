...
public sealed class EquipUpgradeRequest : IMessage<EquipUpgradeRequest>, IMessage, IEquatable<EquipUpgradeRequest>, IDeepCloneable<EquipUpgradeRequest>, IBufferMessage
{
	...
	public static MessageParser<EquipUpgradeRequest> Parser => _parser;

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => EquipUpgradeRequestReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public EquipUpgradeRequest(EquipUpgradeRequest other)
		: this()
	{
		seq_ = other.seq_;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public EquipUpgradeRequest Clone()
	{
		return new EquipUpgradeRequest(this);
	}
	...
	{
		return Equals(other as EquipUpgradeRequest);
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public bool Equals(EquipUpgradeRequest other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(EquipUpgradeRequest other)
	{
		if (other != null)
		{
			if (other.Seq != 0)
