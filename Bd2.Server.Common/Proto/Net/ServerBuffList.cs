...
public sealed class ServerBuffList : IMessage<ServerBuffList>, IMessage, IEquatable<ServerBuffList>, IDeepCloneable<ServerBuffList>, IBufferMessage
{
	private static readonly MessageParser<ServerBuffList> _parser = new MessageParser<ServerBuffList>(() => new ServerBuffList());
	...
	[DebuggerNonUserCode]
	public static MessageParser<ServerBuffList> Parser => _parser;

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => BuffListInfoReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ServerBuffList()
	{
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ServerBuffList(ServerBuffList other)
		: this()
	{
		id_ = other.id_;
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public ServerBuffList Clone()
	{
		return new ServerBuffList(this);
	}
	...
	{
		return Equals(other as ServerBuffList);
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public bool Equals(ServerBuffList other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public void MergeFrom(ServerBuffList other)
	{
		if (other != null)
		{
			if (other.Id != 0)
