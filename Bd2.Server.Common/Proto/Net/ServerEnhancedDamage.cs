...
public sealed class ServerEnhancedDamage : IMessage<ServerEnhancedDamage>, IMessage, IEquatable<ServerEnhancedDamage>, IDeepCloneable<ServerEnhancedDamage>, IBufferMessage
{
	private static readonly MessageParser<ServerEnhancedDamage> _parser = new MessageParser<ServerEnhancedDamage>(() => new ServerEnhancedDamage());
	...
	public static MessageParser<ServerEnhancedDamage> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => BuffListInfoReflection.Descriptor.MessageTypes[14];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ServerEnhancedDamage()
	{
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public ServerEnhancedDamage(ServerEnhancedDamage other)
		: this()
	{
		id_ = other.id_;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ServerEnhancedDamage Clone()
	{
		return new ServerEnhancedDamage(this);
	}
	...
	{
		return Equals(other as ServerEnhancedDamage);
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public bool Equals(ServerEnhancedDamage other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public void MergeFrom(ServerEnhancedDamage other)
	{
		if (other != null)
		{
			if (other.Id != 0)
