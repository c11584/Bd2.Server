...
public sealed class ServerChainBonusBuff : IMessage<ServerChainBonusBuff>, IMessage, IEquatable<ServerChainBonusBuff>, IDeepCloneable<ServerChainBonusBuff>, IBufferMessage
{
	private static readonly MessageParser<ServerChainBonusBuff> _parser = new MessageParser<ServerChainBonusBuff>(() => new ServerChainBonusBuff());
	...
	public static MessageParser<ServerChainBonusBuff> Parser => _parser;

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => BuffListInfoReflection.Descriptor.MessageTypes[12];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ServerChainBonusBuff()
	{
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public ServerChainBonusBuff(ServerChainBonusBuff other)
		: this()
	{
		id_ = other.id_;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ServerChainBonusBuff Clone()
	{
		return new ServerChainBonusBuff(this);
	}
	...
	{
		return Equals(other as ServerChainBonusBuff);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(ServerChainBonusBuff other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(ServerChainBonusBuff other)
	{
		if (other != null)
		{
			if (other.Id != 0)
