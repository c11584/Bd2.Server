...
public sealed class ServerVulnerableBuff : IMessage<ServerVulnerableBuff>, IMessage, IEquatable<ServerVulnerableBuff>, IDeepCloneable<ServerVulnerableBuff>, IBufferMessage
{
	private static readonly MessageParser<ServerVulnerableBuff> _parser = new MessageParser<ServerVulnerableBuff>(() => new ServerVulnerableBuff());
	...
	[DebuggerNonUserCode]
	public static MessageParser<ServerVulnerableBuff> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => BuffListInfoReflection.Descriptor.MessageTypes[8];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ServerVulnerableBuff()
	{
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ServerVulnerableBuff(ServerVulnerableBuff other)
		: this()
	{
		id_ = other.id_;
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public ServerVulnerableBuff Clone()
	{
		return new ServerVulnerableBuff(this);
	}
	...
	{
		return Equals(other as ServerVulnerableBuff);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(ServerVulnerableBuff other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(ServerVulnerableBuff other)
	{
		if (other != null)
		{
			if (other.Id != 0)
