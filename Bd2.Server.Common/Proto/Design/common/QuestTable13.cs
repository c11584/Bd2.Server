...
public sealed class QuestTable13 : IMessage<QuestTable13>, IMessage, IEquatable<QuestTable13>, IDeepCloneable<QuestTable13>, IBufferMessage
{
	private static readonly MessageParser<QuestTable13> _parser = new MessageParser<QuestTable13>(() => new QuestTable13());
	...
	[DebuggerNonUserCode]
	public static MessageParser<QuestTable13> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => QuestTable13Reflection.Descriptor.MessageTypes[0];
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public QuestTable13(QuestTable13 other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public QuestTable13 Clone()
	{
		return new QuestTable13(this);
	}
	...
	{
		return Equals(other as QuestTable13);
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public bool Equals(QuestTable13 other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(QuestTable13 other)
	{
		if (other != null)
		{
