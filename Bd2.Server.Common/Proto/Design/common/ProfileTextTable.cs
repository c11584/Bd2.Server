...
public sealed class ProfileTextTable : IMessage<ProfileTextTable>, IMessage, IEquatable<ProfileTextTable>, IDeepCloneable<ProfileTextTable>, IBufferMessage
{
	private static readonly MessageParser<ProfileTextTable> _parser = new MessageParser<ProfileTextTable>(() => new ProfileTextTable());
	...
	[DebuggerNonUserCode]
	public static MessageParser<ProfileTextTable> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => ProfileTextTableReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ProfileTextTable()
	{
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public ProfileTextTable(ProfileTextTable other)
		: this()
	{
		date_ = other.date_;
		id_ = other.id_;
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public ProfileTextTable Clone()
	{
		return new ProfileTextTable(this);
	}
	...
	{
		return Equals(other as ProfileTextTable);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(ProfileTextTable other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(ProfileTextTable other)
	{
		if (other != null)
		{
