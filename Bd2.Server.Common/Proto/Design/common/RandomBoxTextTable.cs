...
public sealed class RandomBoxTextTable : IMessage<RandomBoxTextTable>, IMessage, IEquatable<RandomBoxTextTable>, IDeepCloneable<RandomBoxTextTable>, IBufferMessage
{
	private static readonly MessageParser<RandomBoxTextTable> _parser = new MessageParser<RandomBoxTextTable>(() => new RandomBoxTextTable());
	...
	[DebuggerNonUserCode]
	public static MessageParser<RandomBoxTextTable> Parser => _parser;

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => RandomBoxTextTableReflection.Descriptor.MessageTypes[0];
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public RandomBoxTextTable()
	{
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RandomBoxTextTable(RandomBoxTextTable other)
		: this()
	{
		date_ = other.date_;
		id_ = other.id_;
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public RandomBoxTextTable Clone()
	{
		return new RandomBoxTextTable(this);
	}
	...
	{
		return Equals(other as RandomBoxTextTable);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(RandomBoxTextTable other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public void MergeFrom(RandomBoxTextTable other)
	{
		if (other != null)
		{
