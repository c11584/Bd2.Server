...
public sealed class QuestTable1004 : IMessage<QuestTable1004>, IMessage, IEquatable<QuestTable1004>, IDeepCloneable<QuestTable1004>, IBufferMessage
{
	private static readonly MessageParser<QuestTable1004> _parser = new MessageParser<QuestTable1004>(() => new QuestTable1004());
	...
	public static MessageParser<QuestTable1004> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => QuestTable1004Reflection.Descriptor.MessageTypes[0];
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public QuestTable1004()
	{
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable1004(QuestTable1004 other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable1004 Clone()
	{
		return new QuestTable1004(this);
	}
	...
	{
		return Equals(other as QuestTable1004);
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public bool Equals(QuestTable1004 other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(QuestTable1004 other)
	{
		if (other != null)
		{
