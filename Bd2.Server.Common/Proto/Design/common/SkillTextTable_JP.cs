...
public sealed class SkillTextTable_JP : IMessage<SkillTextTable_JP>, IMessage, IEquatable<SkillTextTable_JP>, IDeepCloneable<SkillTextTable_JP>, IBufferMessage
{
	private static readonly MessageParser<SkillTextTable_JP> _parser = new MessageParser<SkillTextTable_JP>(() => new SkillTextTable_JP());
	...
	[DebuggerNonUserCode]
	public static MessageParser<SkillTextTable_JP> Parser => _parser;

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => SkillTextTableJPReflection.Descriptor.MessageTypes[0];
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public SkillTextTable_JP()
	{
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public SkillTextTable_JP(SkillTextTable_JP other)
		: this()
	{
		id_ = other.id_;
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public SkillTextTable_JP Clone()
	{
		return new SkillTextTable_JP(this);
	}
	...
	{
		return Equals(other as SkillTextTable_JP);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(SkillTextTable_JP other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(SkillTextTable_JP other)
	{
		if (other != null)
		{
			if (other.Id != 0)
