...
public sealed class QuestTable8 : IMessage<QuestTable8>, IMessage, IEquatable<QuestTable8>, IDeepCloneable<QuestTable8>, IBufferMessage
{
	private static readonly MessageParser<QuestTable8> _parser = new MessageParser<QuestTable8>(() => new QuestTable8());
	...
	[DebuggerNonUserCode]
	public static MessageParser<QuestTable8> Parser => _parser;

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => QuestTable8Reflection.Descriptor.MessageTypes[0];
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public QuestTable8(QuestTable8 other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public QuestTable8 Clone()
	{
		return new QuestTable8(this);
	}
	...
	{
		return Equals(other as QuestTable8);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(QuestTable8 other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(QuestTable8 other)
	{
		if (other != null)
		{
