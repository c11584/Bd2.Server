...
public sealed class QuestTable10 : IMessage<QuestTable10>, IMessage, IEquatable<QuestTable10>, IDeepCloneable<QuestTable10>, IBufferMessage
{
	private static readonly MessageParser<QuestTable10> _parser = new MessageParser<QuestTable10>(() => new QuestTable10());
	...
	public static MessageParser<QuestTable10> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => QuestTable10Reflection.Descriptor.MessageTypes[0];
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public QuestTable10(QuestTable10 other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable10 Clone()
	{
		return new QuestTable10(this);
	}
	...
	{
		return Equals(other as QuestTable10);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(QuestTable10 other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(QuestTable10 other)
	{
		if (other != null)
		{
