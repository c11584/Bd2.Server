...
public sealed class EvilCastleTotalRankTable : IMessage<EvilCastleTotalRankTable>, IMessage, IEquatable<EvilCastleTotalRankTable>, IDeepCloneable<EvilCastleTotalRankTable>, IBufferMessage
{
	private static readonly MessageParser<EvilCastleTotalRankTable> _parser = new MessageParser<EvilCastleTotalRankTable>(() => new EvilCastleTotalRankTable());
	...
	[DebuggerNonUserCode]
	public static MessageParser<EvilCastleTotalRankTable> Parser => _parser;

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => EvilCastleTotalRankTableReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public EvilCastleTotalRankTable()
	{
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public EvilCastleTotalRankTable(EvilCastleTotalRankTable other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public EvilCastleTotalRankTable Clone()
	{
		return new EvilCastleTotalRankTable(this);
	}
	...
	{
		return Equals(other as EvilCastleTotalRankTable);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(EvilCastleTotalRankTable other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(EvilCastleTotalRankTable other)
	{
		if (other != null)
		{
