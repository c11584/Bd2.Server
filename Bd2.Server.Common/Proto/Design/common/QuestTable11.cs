...
public sealed class QuestTable11 : IMessage<QuestTable11>, IMessage, IEquatable<QuestTable11>, IDeepCloneable<QuestTable11>, IBufferMessage
{
	private static readonly MessageParser<QuestTable11> _parser = new MessageParser<QuestTable11>(() => new QuestTable11());
	...
	[DebuggerNonUserCode]
	public static MessageParser<QuestTable11> Parser => _parser;

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => QuestTable11Reflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable11(QuestTable11 other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable11 Clone()
	{
		return new QuestTable11(this);
	}
	...
	{
		return Equals(other as QuestTable11);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(QuestTable11 other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public void MergeFrom(QuestTable11 other)
	{
		if (other != null)
		{
