...
public sealed class QuestTable9 : IMessage<QuestTable9>, IMessage, IEquatable<QuestTable9>, IDeepCloneable<QuestTable9>, IBufferMessage
{
	private static readonly MessageParser<QuestTable9> _parser = new MessageParser<QuestTable9>(() => new QuestTable9());
	...
	[DebuggerNonUserCode]
	public static MessageParser<QuestTable9> Parser => _parser;

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public static MessageDescriptor Descriptor => QuestTable9Reflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable9(QuestTable9 other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable9 Clone()
	{
		return new QuestTable9(this);
	}
	...
	{
		return Equals(other as QuestTable9);
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public bool Equals(QuestTable9 other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(QuestTable9 other)
	{
		if (other != null)
		{
