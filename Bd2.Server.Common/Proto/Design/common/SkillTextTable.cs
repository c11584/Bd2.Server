...
public sealed class SkillTextTable : IMessage<SkillTextTable>, IMessage, IEquatable<SkillTextTable>, IDeepCloneable<SkillTextTable>, IBufferMessage
{
	private static readonly MessageParser<SkillTextTable> _parser = new MessageParser<SkillTextTable>(() => new SkillTextTable());
	...
	public static MessageParser<SkillTextTable> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => SkillTextTableReflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public SkillTextTable()
	{
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public SkillTextTable(SkillTextTable other)
		: this()
	{
		id_ = other.id_;
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public SkillTextTable Clone()
	{
		return new SkillTextTable(this);
	}
	...
	{
		return Equals(other as SkillTextTable);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(SkillTextTable other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(SkillTextTable other)
	{
		if (other != null)
		{
			if (other.Id != 0)
