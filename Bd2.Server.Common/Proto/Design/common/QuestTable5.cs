...
public sealed class QuestTable5 : IMessage<QuestTable5>, IMessage, IEquatable<QuestTable5>, IDeepCloneable<QuestTable5>, IBufferMessage
{
	private static readonly MessageParser<QuestTable5> _parser = new MessageParser<QuestTable5>(() => new QuestTable5());
	...
	public static MessageParser<QuestTable5> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => QuestTable5Reflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable5(QuestTable5 other)
		: this()
	{
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public QuestTable5 Clone()
	{
		return new QuestTable5(this);
	}
	...
	{
		return Equals(other as QuestTable5);
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public bool Equals(QuestTable5 other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public void MergeFrom(QuestTable5 other)
	{
		if (other != null)
		{
