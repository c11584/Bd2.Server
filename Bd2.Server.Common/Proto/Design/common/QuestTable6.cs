...
public sealed class QuestTable6 : IMessage<QuestTable6>, IMessage, IEquatable<QuestTable6>, IDeepCloneable<QuestTable6>, IBufferMessage
{
	private static readonly MessageParser<QuestTable6> _parser = new MessageParser<QuestTable6>(() => new QuestTable6());
	...
	[DebuggerNonUserCode]
	public static MessageParser<QuestTable6> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => QuestTable6Reflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable6(QuestTable6 other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable6 Clone()
	{
		return new QuestTable6(this);
	}
	...
	{
		return Equals(other as QuestTable6);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(QuestTable6 other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public void MergeFrom(QuestTable6 other)
	{
		if (other != null)
		{
