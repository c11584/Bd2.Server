...
public sealed class QuestTable3004 : IMessage<QuestTable3004>, IMessage, IEquatable<QuestTable3004>, IDeepCloneable<QuestTable3004>, IBufferMessage
{
	private static readonly MessageParser<QuestTable3004> _parser = new MessageParser<QuestTable3004>(() => new QuestTable3004());
	...
	public static MessageParser<QuestTable3004> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => QuestTable3004Reflection.Descriptor.MessageTypes[0];
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable3004()
	{
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public QuestTable3004(QuestTable3004 other)
		: this()
	{
	...
	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public QuestTable3004 Clone()
	{
		return new QuestTable3004(this);
	}
	...
	{
		return Equals(other as QuestTable3004);
	}

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public bool Equals(QuestTable3004 other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public void MergeFrom(QuestTable3004 other)
	{
		if (other != null)
		{
