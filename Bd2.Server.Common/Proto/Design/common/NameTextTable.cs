...
public sealed class NameTextTable : IMessage<NameTextTable>, IMessage, IEquatable<NameTextTable>, IDeepCloneable<NameTextTable>, IBufferMessage
{
	private static readonly MessageParser<NameTextTable> _parser = new MessageParser<NameTextTable>(() => new NameTextTable());
	...
	public static MessageParser<NameTextTable> Parser => _parser;

	[DebuggerNonUserCode]
	[GeneratedCode("protoc", null)]
	public static MessageDescriptor Descriptor => NameTextTableReflection.Descriptor.MessageTypes[0];
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public NameTextTable()
	{
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public NameTextTable(NameTextTable other)
		: this()
	{
		date_ = other.date_;
		id_ = other.id_;
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public NameTextTable Clone()
	{
		return new NameTextTable(this);
	}
	...
	{
		return Equals(other as NameTextTable);
	}

	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public bool Equals(NameTextTable other)
	{
		if (other != null)
		{
			if (other != this)
	...
	[GeneratedCode("protoc", null)]
	[DebuggerNonUserCode]
	public void MergeFrom(NameTextTable other)
	{
		if (other != null)
		{
